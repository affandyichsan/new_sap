...
<!-- Mirrored from maxartkiller.com/website/fimobile2/HTML/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 09:32:09 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="<?= Url::base()?>/assets_web/img/favicon180.png" sizes="180x180">
    <link rel="icon" href="<?= Url::base()?>/assets_web/img/favicon32.png" sizes="32x32" type="image/png">
    <link rel="icon" href="<?= Url::base()?>/assets_web/img/favicon16.png" sizes="16x16" type="image/png">
        ...
        <div class="row h-100">
            <div class="col-10 col-md-6 col-lg-5 col-xl-3 mx-auto text-center align-self-center">
                <div class="loader-cube-wrap loader-cube-animate mx-auto">
                    <img src="<?= Url::base()?>/assets_web/img/logo.png" alt="Logo">
                </div>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <figure class="avatar avatar-44 rounded-15">
                                        <img src="<?= Url::base()?>/assets_web/img/user1.jpg" alt="">
                                    </figure>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col align-self-center text-center">
                    <div class="logo-small">
                        <img src="<?= Url::base()?>/assets_web/img/logo.png" alt="">
                        <h5>FiMobile</h5>
                    </div>
                </div>
                <div class="col-auto">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-44 shadow-sm rounded-10">
                                        <img src="<?= Url::base()?>/assets_web/img/user3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-auto align-self-center">
                                                <img src="<?= Url::base()?>/assets_web/img/masterocard.png" alt="">
                                            </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <a href="profile.html" class="card text-center">
                                    <div class="card-body">
                                        <figure class="avatar avatar-50 shadow-sm mb-1 rounded-10">
                                            <img src="<?= Url::base()?>/assets_web/img/user4.jpg" alt="">
                                        </figure>
                            ...
                            <div class="swiper-slide">
                                <a href="profile.html" class="card text-center">
                                    <div class="card-body">
                                        <figure class="avatar avatar-50 shadow-sm mb-1 rounded-10">
                                            <img src="<?= Url::base()?>/assets_web/img/user2.jpg" alt="">
                                        </figure>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 align-self-center ps-0">
                                    <img src="<?= Url::base()?>/assets_web/img/offergraphics.png" alt="" class="mw-100">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="list-group list-group-flush bg-none">
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 shadow rounded-10 ">
                                        <img src="<?= Url::base()?>/assets_web/img/company4.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 shadow rounded-10">
                                        <img src="<?= Url::base()?>/assets_web/img/company5.png" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 shadow rounded-10">
                                        <img src="<?= Url::base()?>/assets_web/img/company1.png" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 shadow rounded-10">
                                        <img src="<?= Url::base()?>/assets_web/img/company3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-60 shadow-sm rounded-10 coverimg">
                                        <img src="<?= Url::base()?>/assets_web/img/news.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                    ...
                    <a href="blog-details.html" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-60 shadow-sm rounded-10 coverimg">
                                        <img src="<?= Url::base()?>/assets_web/img/news1.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                    ...
                    <a href="blog-details.html" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-60 shadow-sm rounded-10 coverimg">
                                        <img src="<?= Url::base()?>/assets_web/img/news2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col align-self-center ps-0">
                ...
                <li class="nav-item centerbutton">
                    <div class="nav-link">
                        <span class="theme-radial-gradient">
                            ...
                            <img src="<?= Url::base()?>/assets_web/img/centerbutton.svg" class="nav-icon" alt="" />
                        </span>
    ...
    <div class="position-fixed bottom-0 start-50 translate-middle-x  z-index-10">
        <div class="toast mb-3" role="alert" aria-live="assertive" aria-atomic="true" id="toastinstall"
            ...
            <div class="toast-header">
                <img src="<?= Url::base()?>/assets_web/img/favicon32.png" class="rounded me-2" alt="...">
...
<!-- Mirrored from maxartkiller.com/website/fimobile2/HTML/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 09:33:01 GMT -->
</html>